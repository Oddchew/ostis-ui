...
void HTTPRequestHandler::FileRetriever(ScMemoryContext * context, ScAddr & fileAddr, httplib::Request const & req, httplib::Response & res) noexcept
{
  // file not found
