...
{
public:
  static inline ScKeynode const action_translate_sc_to_html{"action_translate_sc_to_html"};
  ...
  static inline ScKeynode const concept_style{"concept_style", ScType::ConstNodeClass};
  ...
  static inline ScKeynode const nrel_parameter{"nrel_parameter", ScType::ConstNodeNonRole};

  static inline ScKeynode const concept_current_ostis_ui_model{"concept_current_ostis_ui_model", ScType::ConstNode};

  static inline ScKeynode const action_translate_sc_node_to_html{
      "action_translate_sc_node_to_html",
      ScType::ConstNodeClass};
};
